...
- Title naming added items ("with case", "with games", "+ N games", "Bundle") → bundle, not the bare console. The displayed price doesn't represent the console alone. REJECT.
...
Edition variants: Splatoon Edition, Mario Edition, Pokémon Edition, Zelda Edition, Animal Crossing Edition, Limited Edition, Special Edition — these ship with custom colorways/accessories at distinct price tiers from the base console. REJECT cross-edition matches.
