...
export const expensesSummaryDescription =
	"Aggregated cost-side metrics for the window. Calls GET /v1/expenses/summary. Returns counts + costs (acquisition + forwarder + expense). For full P&L combine with /v1/finance/transactions (eBay Finances mirror). Aggregates across every API key belonging to the same owner.";
