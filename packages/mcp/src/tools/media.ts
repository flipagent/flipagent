...
export const ebayPictureUploadInput = Type.Object({
	sourceUrl: Type.String({
		description: "HTTPS URL of the image. flipagent fetches it and forwards to eBay's Picture Hosting in one round-trip. ≤10MB.",
	}),
	...
	pictureName: Type.Optional(Type.String({ maxLength: 100, description: "Free-text label shown in the seller's eBay Picture Manager." })),
});
