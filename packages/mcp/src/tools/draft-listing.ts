...
export const draftListingDescription =
	"Recommend optimal list price + title for a (re)listing. Calls POST /v1/draft. Pass `item` (the SKU you're listing — ItemSummary or ItemDetail) and `market` (from /v1/research/thesis). Returns ListPriceAdvice (`null` when the market lacks duration data — fall back to `market.medianCents`) plus a title suggestion to feed into /v1/inventory/createOrReplaceItem.";
