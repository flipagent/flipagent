...
// The `${setup.dashboardUrl}/...` placeholders below are LITERAL text
// shown to the LLM agent — instructions for it to substitute at
// decision time, not runtime template interpolation. Keep as a plain
// string and silence the curly-brace lint at the assignment.
export const flipagentCapabilitiesDescription =
	// biome-ignore lint/suspicious/noTemplateCurlyInString: intentional literal placeholder for agent-facing prose
