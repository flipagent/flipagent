...
export const MOCK_CANON50: EvaluateFixture = {
	...
	evaluation: {
		...
		confidence: 0.94,
		reason: "$82 — 14% below the 30-day median ($95). Nifty-fifty clears in 3d at p50; $9 net at $92 exit.",
		signals: [
			{ name: "under_median", reason: "Asking 14% below the 30-day median ($95)." },
			{ name: "fast_pace", reason: "1.27 sales/day — 3d median, 6d at p70." },
			{ name: "best_offer", reason: "Best Offer enabled — historic accept rate ~$78." },
			{ name: "complete_kit", reason: "Front + rear caps included — premium vs cap-less listings." },
		],
		safeBidBreakdown: {
		...
		recommendedExit: { listPriceCents: 9214, expectedDaysToSell: 3, netCents: 920, dollarsPerDay: 307 },
	},
	returns: { accepted: true, periodDays: 30, shippingCostPaidBy: "BUYER" },
};
